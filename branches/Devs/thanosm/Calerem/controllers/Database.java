...
public class Database extends SQLiteOpenHelper {
	...
	public long delete_celebration(Celebration celebration) {
		...
		{
			Log.w("Delete_celebration was not succesfull", "no entry in db");
			return 0;
		}
	...
	public long log_messages(MessageLog log) {
		...
		{
			Log.e("log_messages didnt work", "values not correct");
			return 0;
		}
	}
	...
	public Contact get_contact(int contact_id)
	{
		...
		{
			Log.e("couldn't return contact","possibly no entry");
			return null;
		}
	}
	/**
	...
	public Contact[] get_contacts()
	{
		...
		{
			Log.e("couldn't get contacts from database", "possibly no entry");
			return null;
		}
