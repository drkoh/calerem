...
public class NotificationService extends Service
{
	...
	public void onStart(Intent intent, int startid) 
	{
		...
		eventsCeleb = upcommingEvents();
		cele = get_Eort();
		ArrayList<String> finals = findContacts(contacts,cele);
		init_notification(finals,eventsCeleb);
	...
	/**
	 * @author Agapi
	 * This method generades the upcomming events of the next day and returns the necessary information
	 * on a string.
	 * @return String
	 */
	private String upcommingEvents () {
		Event[] even;
		...
		even = db.get_events(System.currentTimeMillis(),System.currentTimeMillis()+86400000);
	 ...
	 * @param contacts,eventsCeleb
	 */
	private void init_notification(ArrayList<String> finals,String eventsCeleb) 
	{
			...
			NotificationBuilder.setContentText(this.CompileNotificationText(finals,eventsCeleb));
	 ...
	 * @param finals,eventsCeleb
	 * @return NotificationText
	 */
	private CharSequence CompileNotificationText(ArrayList<String> finals, String eventsCeleb)
	{
		...
		NotificationText = NotificationText + ". " +eventsCeleb;
		return NotificationText;
	}
